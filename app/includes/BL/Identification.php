	...
	Class BL_Identification
	{
		function Inscription_site($nom,$prenom,$pseudo,$motDePasse,$confMotDePasse,$mail,$repVerifMail)
		{
			...
			else 
			{
				...
				{
					//Différence entre le mot de passe et la confirmation de mot de passe
		...
		function identification($pseudo,$mot_de_passe,$verifIdentification)
		{
			...
			{
				$retourIdentification=array("statut" => 905,"message" =>"<div class=\"reponse_nok\"> Vous êtes déjà enregistré mais votre compte n'est pas encore actif. Merci d'attendre son activation par l'administrateur. </div>");
				return $retourIdentification;
			}
			else
			{
				$retourIdentification=array("statut" => 905,"message" => "<div class=\"reponse_ko\"> Vous n'êtes pas enregistré. Pour vous inscrire sur le site, veuillez remplir les différents champs ci-dessus. </div>");
				return $retourIdentification;
			}
		}
